...
elseif (isset($_POST['url']) && $_POST['url'] != ""):
	echo utf8_encode(htmlentities(html_entity_decode(shoutcast2($_POST['url']), ENT_QUOTES,"ISO-8859-1")));
else:
	echo "";
endif;
...
function customRequest($sURL) {
	//$sURL = $sURL . "/currentsong?sid=1";
	// $sURL = "http://cast.streams.ovh:9001/currentsong?sid=1";
	// $curl = curl_init($sURL);
	...
	curl_setopt_array($curl, array(
		...
		CURLOPT_URL => 'http://cast.streams.ovh/currentsong?sid=1',
		CURLOPT_PORT => '9001',
